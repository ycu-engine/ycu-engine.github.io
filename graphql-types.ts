...
export type MemberIconQuery = { allFile: { nodes: Array<(
      Pick<File, 'name'>
      & { xxs?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixed_WithWebpFragment> }>, xs?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixed_WithWebpFragment> }>, sm?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixed_WithWebpFragment> }>, md?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixed_WithWebpFragment> }>, lg?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixed_WithWebpFragment> }>, xl?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixed_WithWebpFragment> }> }
    )> } };
...
export type TeamIconQuery = { allFile: { nodes: Array<(
      Pick<File, 'name'>
      & { sm?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixed_WithWebpFragment> }>, md?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixed_WithWebpFragment> }>, lg?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixed_WithWebpFragment> }>, xl?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixed_WithWebpFragment> }> }
    )> } };
